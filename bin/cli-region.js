...
async function fetchRepoStars(repo, onProgress) {
  ...
  return { dates, cumulative, dailyDates, dailyValues, hourlyDates, hourlyValues, displayCount, regionDailyDates, regionDailyData, regionHourlyDates, regionHourlyData, allRegionNames, defaultTopN, knownCount, isStale };
}
...
const cmdParts = ['npx gh-star-region', ...repoList];
